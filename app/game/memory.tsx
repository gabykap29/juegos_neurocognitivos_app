...
// Colors for the background flashes
const GAME_COLORS = [
  "#FF0000", // Red
  "#0000FF", // Blue
  "#00FF00", // Green
...
const DIRECTIONS = ["arrow-back", "arrow-forward"] as const;

export default function ReactionDirectionGameScreen() {
  ...
  const [currentDirection, setCurrentDirection] =
    useState<(typeof DIRECTIONS)[number]>("arrow-back");
  ...
  return (
    <ThemedView style={styles.container}>
      <Stack.Screen options={{ title: "Coordinación" }} />
      ...
      {!isPlaying ? (
        <View style={styles.startContainer}>
          <View style={styles.titleSection}>
            ...
            <ThemedText style={styles.description}>
              Aparecerá una flecha direccional con un color de fondo vibrante.
              Reacciona rápidamente moviéndote o lanzando según la dirección
              indicada.
            </ThemedText>
          </View>
        ...
        <View style={styles.gameContainer}>
          ...
          >
            <Ionicons name={currentDirection} size={120} color="white" />
          </Animated.View>
